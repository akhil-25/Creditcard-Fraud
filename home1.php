...
<div class="form-group row">
  <div class="col-xs-2">
    ...
    <h5>Roll Number:<input class="form-control botto" type="number" name="roll" readonly placeholder="roll number" value="<?php echo $result['roll'] ?>" required ></h5>


    <h5>Age:<input class="form-control botto"  type="number" min="0" max="100" name="age" placeholder="age" value="<?php echo $result['age'] ?>" min="0" required ></h5>
    ...
    <button name="submit" onclick="return valid()" class="btn btn-primary btn-lg btn-block login-button botto" >Update</button>
    </form>
    <form action="" method="POST">
    <center><button style="background-color: transparent;border:0" name="reset" >Close</button></center>
    </form>
    </div>
    </div>
    </div>
